  ...
  render(){
    ...
    return(
      <div className="div-principalMenuCentral">
        ...
        <a href="/">
          <img className="img-menuCentral-header" src="http://zapopan.tecmm.edu.mx/imagenes/banner-tecmm.jpg"/>
        </a>
        <img className="img-menuCentral-nombre" src="http://zapopan.tecmm.edu.mx/imagenes/zapopan.png"/>

        <Nav id="menuCentralBootstrap" variant="pills" activeKey="1">
          <Dropdown >
            <Dropdown.Toggle id="dropdownBootstrap">SOMOS TECMM</Dropdown.Toggle>
            <Dropdown.Menu>
              <Dropdown.Item href="/quienesSomos" id="dropdownItemBootstrap">Quienés Somos</Dropdown.Item>
